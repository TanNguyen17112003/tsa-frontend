...
interface MobileStudentFilterDialogProps {
  open: boolean;
  onClose: () => void;
...
const MobileStudentFilterDialog: React.FC<MobileStudentFilterDialogProps> = ({
  open,
  onClose,
  selectedStatus,
  dateRange,
...
export default MobileStudentFilterDialog;
