...
export const errorMap: { [name: string]: string } = {
  'auth/admin-restricted-operation': 'Hoạt động này chỉ dành cho quản trị viên.',
  'auth/argument-error': 'Lỗi đối số.',
  'auth/app-not-authorized': 'Ứng dụng này không được ủy quyền để sử dụng khóa API này.',
  ...
  'auth/dependent-sdk-initialized-before-auth': 'SDK phụ thuộc được khởi tạo trước khi xác thực.',
  ...
  'auth/maximum-second-factor-count-exceeded': 'Đã vượt quá số lượng yếu tố thứ hai tối đa.',
  ...
  'auth/unsupported-tenant-operation': 'Hoạt động không được hỗ trợ của người thuê.',
