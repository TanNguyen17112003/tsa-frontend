...
import { deliveryStatusMap } from 'src/types/delivery';

interface MobileDeliveryFilterDialogProps {
  open: boolean;
  onClose: () => void;
...
const MobileDeliveryFilterDialog: React.FC<MobileDeliveryFilterDialogProps> = ({
  open,
  onClose,
  selectedStatus,
  dateRange,
  ...
  const deliveryStatusList = Object.keys(deliveryStatusMap);
          ...
          <FormControl variant='filled' fullWidth>
            ...
            <Select value={localStatus} onChange={handleLocalStatusChange}>
              ...
              {deliveryStatusList.map((status) => (
                <MenuItem
                  key={status}
                  value={deliveryStatusMap[status as keyof typeof deliveryStatusMap]}
                >
                  {status}
                </MenuItem>
              ))}
...
export default MobileDeliveryFilterDialog;
